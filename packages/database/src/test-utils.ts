...
export async function clearTestDb(em: EntityManager): Promise<void> {
  ...
  const publicTables = ['outbox_event', 'organizations', 'webhook_events', 'api_keys', 'unit_definition', 'substance_alias', 'substance', 'seed_version', 'category_regulatory_list', 'regulatory_list', 'regulatory_list_entry', 'category', 'regulation'];
