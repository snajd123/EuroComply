...
Update implementation status in relevant docs (IMPLEMENTATION_PLAN.md, etc.)
Update architectural docs if design changed (DATA_SOVEREIGNTY.md, ARCHITECTURE_PORTABILITY.md)
Update README.md if user-facing features changed
Mark completion status with clear indicators (✅ Complete, ⚠️ Partial, 📋 Planned)
...
Check if existing deps can solve the problem
Evaluate package health (maintenance, downloads, security)
