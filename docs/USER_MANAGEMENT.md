...
Keys and credentials are managed through a **Wallet** abstraction. This enables future integration with EU Digital Identity (EUDI) Wallets without changing application code.
...
model OrganizationWallet {
  ...
  // Organizations use MANAGED wallets (EUDI is for natural persons)
  did             String
  keyId           String

  // Future: Legal Entity Identifier
...
| Benefit | Description |
|---------|-------------|
| **Future-proof** | EUDI integration requires no application code changes |
| **User choice** | Users can choose their preferred wallet type |
| **Gradual migration** | Organizations can adopt EUDI at their own pace |
