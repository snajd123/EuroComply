...
describe('Category Adoption API E2E', () => {
  ...
  describe('PATCH /category-adoption/:categoryId', () => {
    ...
    // TODO: Add tests for pinnedRegulationIds with new regulation/category_regulation tables
    // These tests were removed during legacy cleanup - need new tests using:
    // - public.regulation table
    // - public.category_regulation table
    // - CategoryAdoption.pinnedRegulationIds field
  });
